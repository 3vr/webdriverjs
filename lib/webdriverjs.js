...
var WebdriverJs = function(options)//host, port, username, pass) 
{
    ...
    if (argv.s === "teamcity") {
        self.logPrefix = {
            testStart : "##teamcity[testSuiteStarted name=",
            testFinish : "##teamcity[testFinished name=",
            testOut : "##teamcity[testStdOut name=",
            testFail : "##teamcity[testFailed name="
        };
    }
...
WebdriverJs.prototype.showTest = function(theTest, receivedValue, expectedValue, message) {
    ...
    if (argv.s) { console.log(this.logPrefix.testStart + message +"]"); }

    if (theTest)
	{
        if (argv.s) {
            console.log(this.logPrefix.testOut + message + " out='" + colors.green + "✔  " + colors.reset + message + "']")
        }
        else
        {
	...
	{
		if (argv.s) {
            console.log(this.logPrefix.testFail + message + " message=" + message + "details='" + expectedValue + " !== " + receivedValue +"']");
        }
        else
        {
    ...
    if (argv.s) { console.log(this.logPrefix.testFinish + message + "]"); }
};
