...
WebdriverJs.prototype.showTest = function(theTest, receivedValue, expectedValue, message) {
    ...
    if (argv.s) { console.log(logPrefix.testStart + message +"]"); }

    if (theTest)
	{
        if (argv.s) {
            console.log(logPrefix.testOut + message + " out='" + colors.green + "✔  " + colors.reset + message + "']")
        }
        else
        {
	...
	{
		if (argv.s) {
            console.log(logPrefix.testFail + message + " message=" + message + "details='" + expectedValue + " !== " + receivedValue +"']");
        }
        else
        {
    ...
    if (argv.s) { console.log(logPrefix.testFinish + message + "]"); }
};
